/*
 Вам нужно реализовать структуру данных, которая поддерживает
  очередь элементов и обрабатывает запросы следующих типов:
 + x: добавить число x в конец очереди;
 * x: вставить число x в середину очереди (если в очереди
  нечётное число элементов, то x встаёт сразу за центральным
  элементом);
